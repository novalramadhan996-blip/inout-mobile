class ResponseEventAttachment {
  ...
  ResponseEventAttachment.fromJson(Map<String, dynamic> json) {
  ...
  static List<ResponseEventAttachment> fromList(List<dynamic> data) {
    return data.map((e) => ResponseEventAttachment.fromJson(e)).toList();
  }
}
