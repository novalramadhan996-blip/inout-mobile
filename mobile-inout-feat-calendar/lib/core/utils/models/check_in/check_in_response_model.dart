class CheckInResponseModel {
  ...
  factory CheckInResponseModel.fromJson(Map<String, dynamic> json) {
    return CheckInResponseModel(
      ...
      workingLatitude: (json['working_latitude'] as num?)?.toDouble(),
      workingLongitude: (json['working_longitude'] as num?)?.toDouble(),
      ...
      latitudeOut: (json['latitude_out'] as num?)?.toDouble(),
      longitudeOut: (json['longitude_out'] as num?)?.toDouble(),
      ...
      radiusIn: (json['radius_in'] as num?)?.toDouble(),
      radiusOut: (json['radius_out'] as num?)?.toDouble(),
      diffTimeIn: json['diff_time_in'] as int?,
      diffTimeOut: json['diff_time_out'] as int?,
      appsId: json['apps_id'],
